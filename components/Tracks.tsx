...
export function Tracks() {
  ...
  return (
    <section id="tracks" className="border-2 border-blue-800 text-slate-800 mx-10 p-5 shadow-xl rounded-xl">
      <h2 className="text-3xl font-bold mb-4 text-center bg-lmain rounded-3xl">Tracks *(TBD)</h2>
